...
# static fields
.field private static zza:Lcom/google/firebase/iid/zzan;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzan;->zzb:Ljava/lang/String;

    iput-object v0, p0, Lcom/google/firebase/iid/zzan;->zzc:Ljava/lang/Boolean;

    iput-object v0, p0, Lcom/google/firebase/iid/zzan;->zzd:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzan;->zze:Ljava/util/Queue;

    return-void
.end method

.method public static declared-synchronized zza()Lcom/google/firebase/iid/zzan;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/iid/zzan;->zza:Lcom/google/firebase/iid/zzan;

    if-nez v1, :cond_0

    new-instance v1, Lcom/google/firebase/iid/zzan;

    invoke-direct {v1}, Lcom/google/firebase/iid/zzan;-><init>()V

    sput-object v1, Lcom/google/firebase/iid/zzan;->zza:Lcom/google/firebase/iid/zzan;
...
.method private final zzb(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/firebase/iid/zzan;->zzc(Landroid/content/Context;Landroid/content/Intent;)Ljava/lang/String;
    ...
    :cond_2
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/google/firebase/iid/zzan;->zza(Landroid/content/Context;)Z
...
.method private final declared-synchronized zzc(Landroid/content/Context;Landroid/content/Intent;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzan;->zzb:Ljava/lang/String;

    if-eqz v0, :cond_0

    iget-object p1, p0, Lcom/google/firebase/iid/zzan;->zzb:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_0
    iput-object p1, p0, Lcom/google/firebase/iid/zzan;->zzb:Ljava/lang/String;
...
.method public final zza(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzan;->zze:Ljava/util/Queue;
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/firebase/iid/zzan;->zzb(Landroid/content/Context;Landroid/content/Intent;)I
...
.method final zza(Landroid/content/Context;)Z
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/zzan;->zzc:Ljava/lang/Boolean;
    ...
    iput-object p1, p0, Lcom/google/firebase/iid/zzan;->zzc:Ljava/lang/Boolean;

    :cond_1
    iget-object p1, p0, Lcom/google/firebase/iid/zzan;->zzc:Ljava/lang/Boolean;
...
.method final zzb(Landroid/content/Context;)Z
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/zzan;->zzd:Ljava/lang/Boolean;
    ...
    iput-object p1, p0, Lcom/google/firebase/iid/zzan;->zzd:Ljava/lang/Boolean;
    ...
    :cond_2
    iget-object p1, p0, Lcom/google/firebase/iid/zzan;->zzd:Ljava/lang/Boolean;
