...
.method static synthetic access$200(Ljava/lang/String;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    .locals 0
...
.method public static declared-synchronized loadAppGateKeepersAsync()V
    ...
    invoke-static {v8, v5}, Lcom/facebook/internal/Utility;->logd(Ljava/lang/String;Ljava/lang/Exception;)V

    :goto_0
    if-eqz v7, :cond_2

    invoke-static {v2, v7}, Lcom/facebook/internal/FetchedAppGateKeepersManager;->parseAppGateKeepersFromJSON(Ljava/lang/String;Lorg/json/JSONObject;)Lorg/json/JSONObject;

    :cond_2
    sget-object v5, Lcom/facebook/internal/FetchedAppGateKeepersManager;->isLoading:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v5, v2, v1, v3}, Lcom/facebook/internal/FetchedAppGateKeepersManager$1;-><init>(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)V
